...
public class SimpleConcurrentSolutionV2 {
    ...
    private static class ResourceCheckTask implements Runnable {
        ...
        public ResourceCheckTask(int id) {
            this.id = id;
        }
        ...
        public void run() {
            ...
            try {
                ...
                System.out.println("[" + currentThread.getName() + "] Verificando Recurso " + this.id + " (Duração: " + sleepTime + "ms)...");
