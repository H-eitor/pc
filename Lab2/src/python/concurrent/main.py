...
class Classes:
    ...
    def __init__(self, num_classes: int, num_students_per_class: int) -> None:
        ...
        self.max_grades: List[float] = [-1 for _ in range(num_classes)]
    ...
    def process_grades(self, class_id: int) -> None:
        ...
        for student_id in their_alumni:
            ...
            self.max_grades[class_id - 1] = num_grade if num_grade > self.max_grades[class_id - 1] else self.max_grades[class_id - 1]
    ...
    def registry_to_string(self, class_id: int) -> None:
        ...
        print(f"Class {class_id} max grade: {self.max_grades[class_id - 1]}")
